...
public class ContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        String azureDbUrl= System.getenv("AZURE_SQL_CONNECTIONSTRING");
        if (azureDbUrl!=null) {
            logger.info("Detected Azure SQL connection string. Adding Tomcat data source...");
            props.put("jakarta.persistence.nonJtaDataSource", "java:comp/env/jdbc/AZURE_SQL_CONNECTIONSTRING_DS");
        }
